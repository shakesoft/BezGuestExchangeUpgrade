...
public class BEZNgCoreDbContext : AbpZeroDbContext<Tenant, Role, User, BEZNgCoreDbContext>, IOpenIddictDbContext
{
    ...
    public virtual DbSet<GuestIdentityType> GuestIdentityTypes { get; set; }
    public virtual DbSet<BEZNgCore.IrepairModel.Region> Regions { get; set; }
    public virtual DbSet<Control> Control { get; set; }
    public virtual DbSet<Currency> Currency { get; set; }
    public virtual DbSet<BEZNgCore.IrepairModel.Document> Document { get; set; }
    public virtual DbSet<GeneralProfile> GeneralProfile { get; set; }
    public virtual DbSet<Guest> Guest { get; set; }
    public virtual DbSet<History> History { get; set; }
    public virtual DbSet<BEZNgCore.IrepairModel.Item> Item { get; set; }
    ...
    public virtual DbSet<BEZNgCore.IrepairModel.Room> Room { get; set; }
