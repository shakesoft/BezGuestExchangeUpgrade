...
public static class AppPermissions
{
    ...
    public const string Pages_Guests_Delete = "Pages.Guests.Delete";

    public const string Pages_GuestsFolio = "Pages.GuestsFolio";
    public const string Pages_GuestsFolio_Create = "Pages.GuestsFolio.Create";
    public const string Pages_GuestsFolio_Edit = "Pages.GuestsFolio.Edit";
    public const string Pages_GuestsFolio_Delete = "Pages.GuestsFolio.Delete";
